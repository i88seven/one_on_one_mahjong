        ...
        children: <Widget>[
          ...
          ExpansionTile(
            ...
            children: convertToStatisticsRow([
              ...
              "通信切断 : ${_gameUserStatistics.disconnectionGame} 回",
              "勝ち : ${_gameUserStatistics.winGame} 回",
              "負け : ${_gameUserStatistics.loseGame} 回",
              "引き分け : ${_gameUserStatistics.drawGame} 回",
            ]),
          ),
          ExpansionTile(
            expandedCrossAxisAlignment: CrossAxisAlignment.stretch,
            ...
            children: convertToStatisticsRow([
              "総局数 : ${_gameUserStatistics.totalRound} 回",
              "引き分け : ${_gameUserStatistics.drawnRound} 回",
              "勝ち : ${_gameUserStatistics.winRound} 回",
              "負け : ${_gameUserStatistics.loseRound} 回",
